...
func ExpectPolicyEnforcementUpdated(vm *helpers.Kubectl, policyEnforcementType string) {
...
func ExpectEndpointSummary(vm *helpers.Kubectl, policyEnforcementType string, numWithPolicyEnforcementType int) {

...
// IngressCoversContext checks if the receiver's ingress `RealizedL4Policy` contains
...
// EgressCoversContext checks if the receiver's egress `RealizedL4Policy` contains
// all `dPorts` and `labels`.
